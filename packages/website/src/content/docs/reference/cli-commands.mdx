...
Generate TypeScript types from live tool schemas. Writes output to `node_modules/muxed/muxed.generated.d.ts`. See the [Programmatic API](/reference/programmatic-api/#type-generation-with-muxed-typegen) reference for details on how generated types integrate with the client.
...
# Error: Tool not found: slack/search_msgs
